...
data = """[1518-04-22 00:52] wakes up
...
sorted_data = sorted(data_list,key=lambda each_dict: (datetime.datetime.strptime(each_dict['date'], '%d-%b-%Y'),datetime.datetime.strptime(each_dict['time'], '%H:%M:%S.%f')))
print(sorted_data)
